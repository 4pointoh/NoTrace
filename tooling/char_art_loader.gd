...
func _run() -> void:
	var character_variant: String = 'lisa_part_new_AUTOTEST'
	var character_resource: String = 'res://data/characters/lisa/lisa_party_AUTO/lisa_party_AUTO.tres'
	var char_art_directory: String = "res://data/characters/lisa/lisa_party/character_art/"         # Where .png files are located
