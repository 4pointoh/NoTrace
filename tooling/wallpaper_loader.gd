...
func _run() -> void:
	var wallpaper_png_path = 'res://data/wallpapers/ashely_selfie1.png'
	var wallpaper_hint = 'Beat Ashely In Poker'
	var wallpaper_id = 'ashely_selfie1' #used for unlocking it
